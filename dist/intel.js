...
var PlayerNameIconRowLink = function (player) {
...
var get_hero = function () {
    var gal = NeptunesPride.universe.galaxy;
    var player = gal["player_uid"];
    return gal.players[Number(player)];
};
var get_ledger = function (messages) {
    var loading = Crux.Text("", "rel txt_center pad12").rawHTML("Parsing ".concat(messages.length, " messages."));
    loading.roost(NeptunesPride.npui.activeScreen);
    var uid = get_hero().uid;
    var ledger = {};
    messages
        .filter(function (m) {
    ...
    var players = [];
    for (var _i = 0, _a = Object.entries(NeptunesPride.universe.galaxy.players); _i < _a.length; _i++) {
        var _b = _a[_i], _key = _b[0], p = _b[1];
        p.debt = 0;
    }
    for (var uid_1 in ledger) {
        var player = NeptunesPride.universe.galaxy.players[uid_1];
...
var update_event_cache = function (fetchSize, success, error) {
...
var recieve_new_messages = function (response) {
    ...
    var players = get_ledger(cached_events);
    ...
    players.forEach(function (p) {
        var player = PlayerNameIconRowLink(universe.galaxy.players[p.uid]).roost(npui.activeScreen);
...
var renderLedger = function () {
    ...
    npui.ledgerScreen = function (_config) {
        return npui.Screen("ledger");
    };
    NeptunesPride.np.on("trigger_ledger", function () {
        var ledgerScreen = npui.ledgerScreen();
        var loading = Crux.Text("", "rel txt_center pad12 section_title").rawHTML("Tabulating Ledger...");
    ...
    np.onForgiveDebt = function (event, data) {
        ...
        var player = universe.galaxy.players[targetPlayer];
...
var get_research_text = function () {
...
var apply_hooks = function () {
    NeptunesPride.np.on("share_all_tech", function (event, player) {
        var total_cost = get_tech_trade_cost(get_hero(), player);
...
function Legacy_NeptunesPrideAgent() {
    ...
    var mergeUser = function (event, data) {
        if (NeptunesPride.originalPlayer === undefined) {
            NeptunesPride.originalPlayer = NeptunesPride.universe.player.uid;
        }
        var code = (data === null || data === void 0 ? void 0 : data.split(":")[1]) || otherUserCode;
...
var add_custom_player_panel = function () {
    NeptunesPride.npui.PlayerPanel = function (player, showEmpire) {
        ...
        if (player.uid != get_hero().uid && player.ai == 0) {
            ...
            var total_sell_cost = get_tech_trade_cost(get_hero(), player);
            ...
            var total_buy_cost = get_tech_trade_cost(player, get_hero());
            ...
            techs.forEach(function (tech, i) {
                var one_tech_cost = get_tech_trade_cost(player, get_hero(), tech);
    ...
    function apply_fractional_ships() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        depth = NeptunesPride.gameConfig.turnBased ? 4 : 3;
...
/******/ })()
;
//# sourceMappingURL=data:application/json;charset=utf-8;base64,